    ...
    <div className="pt-24 pb-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          {/* Image - Now much smaller and balanced */}
          ...
          <div className="lg:col-span-8">
            ...
            <div className="prose prose-lg max-w-none text-navy/80 leading-relaxed font-sans">
              <p className="text-xl">
              ...
              <p className="text-navy/80">
                Prior to Purlieu, he served as Partner and Country Director for Fair Isaac Corporation (FICO), where he led the full market entry and expansion in the Philippines. He also founded Purlieu Solutions Inc. in the United States, developing and scaling enterprise software solutions that were adopted globally.
              </p>
              ...
              <div className="mt-16 pt-12 border-t border-cream-deeper">
                <p className="italic text-lg text-navy/80 font-sans">
                ...
                <p className="mt-8 text-navy/70 font-sans">
